...
public class Ventanaspmodales4 extends JFrame {
	
	
		public static void main(String[] args) {  //método main; cuando se ejecuta, es el punto de inicio del programa 
			
			new Ventanaspmodales4(); //nueva instancia de la clase CLASE08092023
			
		}//cierre del método main
		
		Ventanaspmodales4(){ //se define el constructor de la clase CLASE08092023
			...
			public void componentesInit() {
				...
				ImageIcon imagenicon = new ImageIcon(getClass().getResource("/img/dom.jpeg"));
